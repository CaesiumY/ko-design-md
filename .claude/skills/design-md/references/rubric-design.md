...
- All required keys present: `name, slug, category, last_updated, created_at, lang`. There is no `sources` key — `## References` is the only source list.
