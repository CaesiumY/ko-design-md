...
detail page stacks the token cards and the DESIGN.md tab on the same screen as this iframe, so a
sentence the md carries is its third copy there. Write only what the md has no screen for: how to
