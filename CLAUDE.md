...
> **`[src:5]`(몽타주 공식 타이포그래피 문서)를 직접 열어 세었더니 19개**였다 —
> Display 1·2·3 / Title 1·2·3 / Heading 1·2 / Headline 1·2 / Body 1·2 × Normal·Reading /
> Label 1 × Normal·Reading · Label 2 / Caption 1·2. md의 표와 이름까지 일치한다.
> 즉 **번들 README가 브랜드 발행물과 어긋난 경우**이고, "상류 우선"만 기계적으로
> 적용하면 브랜드 공식값을 버리고 번들값으로 되돌리게 된다.
