...
- 사이트 문구를 용어집 어휘로 — 목록 열 "Design Systems"·"Tokens" 를 "Brands"·"LLM Tokens"(상세 배지도 "LLM TOKENS") 로 갈라 디자인 토큰 탭과 구분하고, 프리뷰 없음 안내의 "이 서비스는", about·루트 404·llms.txt 머리말의 "원본 design.md"·"패키지 번들"·"원본 hex", about 의 "주장에는 전부 인용" 과장을 고침
