...
>
> **버전 확인은 별도 시점이다(2026-08-02).** 본문은 1.3.0 기준으로 쓰였고 그때의 최신은 1.4.0이었으나, 팔레트를 담은 CSS가 두 버전에서 바이트 단위로 동일하므로 위 차이는 버전 드리프트가 아니다 [src:4]. 라벨의 날짜(2026-07-29)는 팔레트 값 대조 시점이다.
>
