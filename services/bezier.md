...
6. Bezier Storybook 파운데이션 autodocs — color·alpha-color·alpha-shadow mdx (색·라이트/다크 테마·엘리베이션 토큰 문서). [src:2] Chromatic Storybook의 foundation 문서이자 핸드오프 번들 color.mdx의 출처다.
